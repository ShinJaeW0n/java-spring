...
<%
	...
	Bbs bbs = null;
		...
		out.println("<script>alert('작성된 글이 없습니다.');location.href = 'bbs.jsp';</script>");
			...
			if(bbs.getBbsId()==0)
			out.println("<script>alert('글 번호가 없습니다.');location.href = 'bbs.jsp';</script>");
		}
%>
<!DOCTYPE HTML>
<html>
			...
			<table class="table table-striped text-center table-bordered">
					...
					<tbody>
						<tr>
							...
							<td class = "test-left"><%=bbs != null? bbs.getBbsTitle() : "" %></td>
						</tr>
						<tr>
							<td class = "align-middle">본문</td>			
							<td style="height: 350px; overflow: auto;" class = "test-left"><%=bbs != null? bbs.getBbsContent() : "" %></td>
													 <!-- 길면 밑으로 스크롤 할 수 있게. -->
						</tr>
					</tbody>
				</table>
				...
				%>
				<a href ="delAction.jsp?bbsId=<%=bbs.getBbsId()%>" class="btn btn-danger float-right" onclick = "return confirm('정말 삭제 하시겠습니까?')">삭제</a>
				<% } %>
