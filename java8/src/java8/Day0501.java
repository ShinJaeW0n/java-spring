...
//		String result = inputNumber % 2 == 0? "짝수" : "홀수"; //삼항연산자를 사용. 하지만 삼항연산자는 한 줄만 출력가능.
		String result = ""; //숫자형은 0으로 초기화하고 문자열은 ""으로 초기화 합니다.
		
		if (inputNumber % 2 == 0) { //if문을 사용하여 조건이 참일 경우 실행하는 중괄호 영역을 작성.
			result = "짝수";
